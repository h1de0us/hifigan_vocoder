...
class BaseTrainer:
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        if (
                ...
                checkpoint["config"]["generator_lr_scheduler"] != self.config["generator_lr_scheduler"]
        ):
            self.logger.warning(
        ...
        if (
                ...
                checkpoint["config"]["discriminator_lr_scheduler"] != self.config["discriminator_lr_scheduler"]
        ):
            self.logger.warning(
